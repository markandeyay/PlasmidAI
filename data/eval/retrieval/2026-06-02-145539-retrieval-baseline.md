...
Compared with expanded-corpus baseline `data/eval/retrieval/2026-06-02-034424-retrieval-baseline.md`:

| Metric | Prior expanded baseline | Robustness rerun | Change |
| --- | ---: | ---: | ---: |
| Top-1 hit rate | `0.850` | `0.950` | `+0.100` |
| Top-5 hit rate | `0.950` | `1.000` | `+0.050` |
| MRR | `0.900` | `0.975` | `+0.075` |
| Clarification pass rate | `1.000` | `1.000` | `0.000` |

The low-copy chloramphenicol regression is fixed: `curated:pACYC184` now ranks `1` with score `0.7736` for the sentinel query.
...
Retrieved:
- 1. `curated:pBluescript-II-SK-minus` pBluescript II SK(-) score=`0.7924` fields=`semantic, vector_type, organism, application`
- 2. `curated:pUC19` pUC19c score=`0.7894` fields=`semantic, vector_type, organism, application`

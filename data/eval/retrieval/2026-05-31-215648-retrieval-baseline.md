...
- Generated at: `2026-05-31T21:56:48.264685+00:00`
...
Retrieved:
- 1. `genbank:U07168.1` Cloning vector pUCP26, Escherichia-Pseudomonas shuttle vector with tetracycline efflux protein (tet) and LacZ alpha peptide (lacZ alpha) genes, complete sequence score=`0.7934` fields=`semantic, vector_type, organism, markers`
...
Retrieved:
- 1. `genbank:U47121.2` Cloning vector pSI, mammalian expression vector, complete sequence score=`0.6917` fields=`semantic, vector_type, organism, markers, promoters, application`
- 2. `curated:pGL3-Basic` pGL3-Basic score=`0.6715` fields=`semantic, vector_type, organism, markers`
- 3. `genbank:U47120.2` Cloning vector pCI-neo, mammalian expression vector, complete sequence score=`0.6398` fields=`semantic, vector_type, organism, markers, promoters, application`
- 4. `genbank:U47119.2` Cloning vector pCI, mammalian expression vector, complete sequence score=`0.6351` fields=`semantic, vector_type, organism, markers, application`
- 5. `genbank:AF058756.1` Cloning vector pFR-Luc, complete sequence score=`0.6220` fields=`semantic, vector_type, organism, markers`
...
Retrieved:
- 1. `curated:pGL3-Basic` pGL3-Basic score=`0.7413` fields=`semantic, vector_type, organism, markers, genes`
- 2. `curated:pGL4-10-luc2` pGL4.10[luc2] score=`0.7409` fields=`semantic, vector_type, organism, markers, genes`
- 3. `genbank:AF058756.1` Cloning vector pFR-Luc, complete sequence score=`0.6931` fields=`semantic, vector_type, organism, markers, genes`
- 4. `genbank:U47121.2` Cloning vector pSI, mammalian expression vector, complete sequence score=`0.5948` fields=`semantic, vector_type, organism, markers`
- 5. `genbank:U47120.2` Cloning vector pCI-neo, mammalian expression vector, complete sequence score=`0.5537` fields=`semantic, vector_type, organism, markers`
...
Retrieved:
- 1. `genbank:U07168.1` Cloning vector pUCP26, Escherichia-Pseudomonas shuttle vector with tetracycline efflux protein (tet) and LacZ alpha peptide (lacZ alpha) genes, complete sequence score=`0.6517` fields=`semantic, organism, markers`
- 2. `curated:pACYC184` pACYC184 score=`0.6473` fields=`semantic, organism, markers`
- 3. `genbank:AY428809.1` Cloning vector pSUP202, complete sequence score=`0.6465` fields=`semantic, organism, markers`
- 4. `curated:pBR322` pBR322 score=`0.6316` fields=`semantic, organism, markers`
- 5. `genbank:CP190850.1` Staphylococcus epidermidis strain LaCa_111 plasmid pLaCa_111b, complete sequence score=`0.4476` fields=`semantic, organism, markers`

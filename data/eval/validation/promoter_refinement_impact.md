# Promoter Refinement Impact

- Generated at: `2026-06-18T02:09:02.783320+00:00`
- Candidate count: `13`
...
| `U47121.2` | `mammalian_expression_vector` | `FAIL` | `repeat_and_instability` | `-` | `False` |
| `AF058756.1` | `mammalian_reporter_vector` | `FAIL` | `repeat_and_instability, codon_usage, regulatory_compatibility` | `-` | `False` |
| `AF041805.1` | `yeast_shuttle_vector` | `FAIL` | `repeat_and_instability` | `-` | `False` |
| `AF041806.1` | `yeast_shuttle_vector` | `FAIL` | `repeat_and_instability` | `-` | `False` |
| `AF041807.1` | `yeast_shuttle_vector` | `FAIL` | `repeat_and_instability` | `-` | `False` |

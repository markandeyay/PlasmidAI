...
- **Current Phase:** Phase 0 corpus expansion/parser-quality branch complete on `phase0-corpus-expansion`; ready for human review
- **Next Concrete Task:** Human review of expanded-corpus retrieval regression and decision on chloramphenicol low-copy gold/ranking behavior; do not push or merge without explicit approval.
...
RESUME HERE: `phase0-corpus-expansion` is ready for human review and has not been pushed or merged. Branch deliverables are complete: corpus expansion strategy, lenti/CRISPR accession-path assessment, parser audit, parser hardening, GenBank expansion mode, expanded ingestion/reprocess/quality reports, retrieval evaluation, and final tests. Final corpus quality report: `data/eval/quality/2026-06-02-033530-quality-report.{md,json}` with 206 total records, 194 GenBank records, 12 curated records, 137/206 complete annotations (66.5%), 65 unknown profiles, 3 duplicate clusters, and 0 parse errors. Retrieval rerun: `data/eval/retrieval/2026-06-02-034424-retrieval-baseline.{md,json}` scored top-1 `0.850`, top-5 `0.950`, MRR `0.900`, clarification pass rate `1.000`; top-5 regressed on the chloramphenicol low-copy `pACYC184` query because expanded GenBank chloramphenicol records outrank the curated target. Final verification passed with `C:\Program Files (x86)\GnuWin32\bin\make.exe test` (217 passed, 1 skipped, 2 warnings).

## KNOWN ISSUES / BLOCKERS
- `phase0-corpus-expansion` is ready for review but intentionally not merged to `master` and not pushed to GitHub.
...
- Phase 1 retrieval gate passed on 2026-05-31: `data/eval/retrieval/2026-05-31-221057-retrieval-baseline.{md,json}` scores 20 retrieval queries plus 1 clarification-only case with top-1 `0.700`, top-5 `1.000`, MRR `0.825`, and clarification pass rate `1.000`. Expanded-corpus rerun on 2026-06-02 improved top-1 to `0.850` and MRR to `0.900` but regressed top-5 to `0.950`.

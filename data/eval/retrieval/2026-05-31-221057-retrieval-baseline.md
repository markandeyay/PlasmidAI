...
- Generated at: `2026-05-31T22:10:57.492098+00:00`
...
Retrieved:
- 1. `curated:pUC18` pUC18 score=`0.6271` fields=`semantic, organism, genes`
- 2. `curated:pGEX-4T-1` pGEX-4T-1 score=`0.6233` fields=`semantic, organism, genes, tags`
- 3. `genbank:AF147463.1` T7 Expression vector pNam, complete sequence score=`0.6048` fields=`semantic, organism`
- 4. `genbank:U47626.2` Cloning vector PinPoint<TM> Xa-1, complete sequence score=`0.5886` fields=`semantic, organism`
- 5. `curated:pUC19` pUC19c score=`0.5776` fields=`semantic, organism, genes`
...
Retrieved:
- 1. `genbank:AY428809.1` Cloning vector pSUP202, complete sequence score=`0.8011` fields=`semantic, vector_type, organism, markers, application`
- 2. `curated:pBR322` pBR322 score=`0.7927` fields=`semantic, vector_type, organism, markers, application`
...
Retrieved:
- 1. `genbank:U47121.2` Cloning vector pSI, mammalian expression vector, complete sequence score=`0.6494` fields=`semantic, vector_type, organism, markers, promoters, application`
...
Retrieved:
- 1. `curated:pGL4-10-luc2` pGL4.10[luc2] score=`0.7768` fields=`semantic, vector_type, organism, markers, genes`
- 2. `curated:pGL3-Basic` pGL3-Basic score=`0.7538` fields=`semantic, vector_type, organism, markers, genes`
- 3. `genbank:AF058756.1` Cloning vector pFR-Luc, complete sequence score=`0.7266` fields=`semantic, vector_type, organism, markers, genes`
...
Retrieved:
- 1. `curated:pRS415` pRS415 score=`0.8236` fields=`semantic, vector_type, organism`
- 2. `curated:pRS416` pRS416 score=`0.8226` fields=`semantic, vector_type, organism`
- 3. `genbank:PV135004.1` Zygosaccharomyces rouxii culture ATCC:56076 plasmid pSB3, complete sequence score=`0.7481` fields=`semantic, vector_type, organism`
...
Retrieved:
- 1. `genbank:PZ138287.1` Aeromonas salmonicida subsp. salmonicida strain 2402/89 plasmid pRAS1_2402_89, complete sequence score=`0.6738` fields=`semantic, organism, markers`

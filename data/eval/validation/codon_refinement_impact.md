# Codon Refinement Impact

- Generated at: `2026-06-18T02:07:02.569786+00:00`
- Candidate count: `13`
- Outcome counts: `{'FAIL': 12, 'PASS': 1}`
...
| `U47121.2` | `mammalian_expression_vector` | `FAIL` | `repeat_and_instability, regulatory_compatibility` | `-` | `False` |
| `AF058756.1` | `mammalian_reporter_vector` | `FAIL` | `repeat_and_instability, codon_usage, regulatory_compatibility` | `-` | `False` |
| `AF041805.1` | `yeast_shuttle_vector` | `FAIL` | `repeat_and_instability, regulatory_compatibility` | `-` | `False` |
| `AF041806.1` | `yeast_shuttle_vector` | `FAIL` | `repeat_and_instability, regulatory_compatibility` | `-` | `False` |
| `AF041807.1` | `yeast_shuttle_vector` | `FAIL` | `repeat_and_instability, regulatory_compatibility` | `-` | `False` |
...
- `repeat_and_instability` `FAIL`: direct repeat of at least 40 bp may promote recombination or synthesis instability.
- `codon_usage` `PASS`: No GOI coding region was annotated; codon-usage scoring skipped.
- `regulatory_compatibility` `FAIL`: Promoter 'T7 promoter' is not compatible with the requested mammalian host context.
...
- `repeat_and_instability` `FAIL`: direct repeat of at least 40 bp may promote recombination or synthesis instability.
- `codon_usage` `PASS`: No GOI coding region was annotated; codon-usage scoring skipped.
- `regulatory_compatibility` `FAIL`: Promoter 'T7 promoter' is not compatible with the requested yeast host context.
